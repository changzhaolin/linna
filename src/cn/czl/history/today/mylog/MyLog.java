package cn.czl.history.today.mylog;
...
public class MyLog {  
    ...
    private static String MYLOG_PATH_SDCARD_DIR=Environment.getExternalStorageDirectory()+"/History/log";// 日志文件在sdcard中的路径  
    ...
    private static void writeLogtoFile(String mylogtype, String tag, String text) {// 新建或打开日志文件  
        ...
        String needWriteFiel = logfile.format(nowtime)+EnentApplication.getContext().getTerminaID();  
