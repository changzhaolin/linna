...
public class ImageRoot {
	...
	public List<Pic_Url> getPicUrl() {
		return picUrl;
	}
	public void setPicUrl(List<Pic_Url> picUrl) {
		this.picUrl = picUrl;
	}
	...
	public String toString() {
		return "ImageRoot [e_id=" + e_id + ", title=" + title + ", content="
				+ content + ", picNo=" + picNo + ", picUrl=" + picUrl + "]";
	}
